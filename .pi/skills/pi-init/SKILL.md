---
name: pi-init
description: "处理 pi-init 的代码修改、调试、测试或文档维护时使用；根据任务在架构师、开发测试工程师、文档与收尾工程师之间智能分配职责并自动切换模型，同时指定技术水平、模型类型和 Pi 推理强度。项目定位：用于 Pi 的项目初始化扩展，生成 AGENTS.md、项目记忆文档，以及支持智能职责路由和自动模型切换的项目级 Skill。"
---
